...
for (const i of paisCapital){
    pais_origen.add(new Option(i[0]))
}
for (const i of paisCapital){
    ciudad_origen.add(new Option(i[1]))
}
for (const i of paisCapital){
    pais_destino.add(new Option(i[0]))
}
for (const i of paisCapital){
    ciudad_destino.add(new Option(i[1]))
}